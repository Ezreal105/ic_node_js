...
INCS_Debug := \
	...
	-I/Users/lotus/wst_project/ic_node_js/node_modules/node-addon-api
...
$(builddir)/ic_node.node: GYP_LDFLAGS := $(LDFLAGS_$(BUILDTYPE))
$(builddir)/ic_node.node: LIBS := $(LIBS)
$(builddir)/ic_node.node: GYP_LIBTOOLFLAGS := $(LIBTOOLFLAGS_$(BUILDTYPE))
$(builddir)/ic_node.node: TOOLSET := $(TOOLSET)
$(builddir)/ic_node.node: $(OBJS) $(builddir)/nothing.a FORCE_DO_CMD
	$(call do_cmd,solink_module)

all_deps += $(builddir)/ic_node.node
# Add target alias
.PHONY: ic_node
ic_node: $(builddir)/ic_node.node

# Short alias for building this executable.
.PHONY: ic_node.node
ic_node.node: $(builddir)/ic_node.node

# Add executable to "all" target.
.PHONY: all
all: $(builddir)/ic_node.node
