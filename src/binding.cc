...
Napi::Value f_IC_InitLibrary(const Napi::CallbackInfo &info)
{
    ...
    char *szLicenseKey = info[0].As<Napi::String>().utf8Value().c_str();
    if (!info[0].isString())
    {
...
Napi::Value f_IC_OpenVideoCaptureDevice(const Napi::CallbackInfo &info)
{
    ...
    char *szDeviceName = info[1].As<Napi::String>().utf8Value().c_str();
    if (!info[1].isString())
    {
...
Napi::Value f_IC_SetFormat(const Napi::CallbackInfo &info)
{
    ...
    HGRABBER hGrabber = *info[0].As<Napi::External<HGRABBER>>().Data();
    COLORFORMAT format = (COLORFORMAT)info[1].As<Napi::Number>().int32_t();
    if (!info[1].isNumber())
    {
        Napi::TypeError::New(env, "Wrong type of argument 1").ThrowAsJavaScriptException();
        return env.Undefined();
...
Napi::Value f_IC_SetVideoFormat(const Napi::CallbackInfo &info)
{
    ...
    HGRABBER hGrabber = *info[0].As<Napi::External<HGRABBER>>().Data();
    char *szFormat = info[1].As<Napi::String>().utf8Value().c_str();
    if (!info[1].isString())
    {
        Napi::TypeError::New(env, "Wrong type of argument 1").ThrowAsJavaScriptException();
        return env.Undefined();
...
Napi::Value f_IC_SetVideoNorm(const Napi::CallbackInfo &info)
{
    ...
    HGRABBER hGrabber = *info[0].As<Napi::External<HGRABBER>>().Data();
    char *szNorm = info[1].As<Napi::String>().utf8Value().c_str();
    if (!info[1].isString())
    {
        Napi::TypeError::New(env, "Wrong type of argument 1").ThrowAsJavaScriptException();
        return env.Undefined();
...
Napi::Value f_IC_SetInputChannel(const Napi::CallbackInfo &info)
{
    ...
    HGRABBER hGrabber = *info[0].As<Napi::External<HGRABBER>>().Data();
    char *szChannel = info[1].As<Napi::String>().utf8Value().c_str();
    if (!info[1].isString())
    {
        Napi::TypeError::New(env, "Wrong type of argument 1").ThrowAsJavaScriptException();
        return env.Undefined();
...
Napi::Value f_IC_StartLive(const Napi::CallbackInfo &info)
{
    ...
    HGRABBER hGrabber = *info[0].As<Napi::External<HGRABBER>>().Data();
    int iShow = info[1].As<Napi::Number>().int64_t();
    if (!info[1].isNumber())
    {
        Napi::TypeError::New(env, "Wrong type of argument 1").ThrowAsJavaScriptException();
        return env.Undefined();
...
Napi::Value f_IC_IsCameraPropertyAvailable(const Napi::CallbackInfo &info)
{
    ...
    HGRABBER hGrabber = *info[0].As<Napi::External<HGRABBER>>().Data();
    CAMERA_PROPERTY eProperty = (CAMERA_PROPERTY)info[1].As<Napi::Number>().int32_t();
    if (!info[1].isNumber())
    {
        Napi::TypeError::New(env, "Wrong type of argument 1").ThrowAsJavaScriptException();
        return env.Undefined();
...
Napi::Value f_IC_SetCameraProperty(const Napi::CallbackInfo &info)
{
    ...
    HGRABBER hGrabber = *info[0].As<Napi::External<HGRABBER>>().Data();
    CAMERA_PROPERTY eProperty = (CAMERA_PROPERTY)info[1].As<Napi::Number>().int32_t();
    long lValue = info[2].As<Napi::Number>().int64_t();
    if (!info[1].isNumber())
    {
        Napi::TypeError::New(env, "Wrong type of argument 1").ThrowAsJavaScriptException();
        return env.Undefined();
...
Napi::Value f_IC_EnableAutoCameraProperty(const Napi::CallbackInfo &info)
{
    ...
    HGRABBER hGrabber = *info[0].As<Napi::External<HGRABBER>>().Data();
    int iProperty = info[1].As<Napi::Number>().int64_t();
    int iOnOff = info[2].As<Napi::Number>().int64_t();
    if (!info[1].isNumber())
    {
        Napi::TypeError::New(env, "Wrong type of argument 1").ThrowAsJavaScriptException();
        return env.Undefined();
...
Napi::Value f_IC_IsCameraPropertyAutoAvailable(const Napi::CallbackInfo &info)
{
    ...
    HGRABBER hGrabber = *info[0].As<Napi::External<HGRABBER>>().Data();
    CAMERA_PROPERTY iProperty = (CAMERA_PROPERTY)info[1].As<Napi::Number>().int32_t();
    if (!info[1].isNumber())
    {
        Napi::TypeError::New(env, "Wrong type of argument 1").ThrowAsJavaScriptException();
        return env.Undefined();
...
Napi::Value f_IC_IsVideoPropertyAvailable(const Napi::CallbackInfo &info)
{
    ...
    HGRABBER hGrabber = *info[0].As<Napi::External<HGRABBER>>().Data();
    VIDEO_PROPERTY eProperty = (VIDEO_PROPERTY)info[1].As<Napi::Number>().int32_t();
    if (!info[1].isNumber())
    {
        Napi::TypeError::New(env, "Wrong type of argument 1").ThrowAsJavaScriptException();
        return env.Undefined();
...
Napi::Value f_IC_SnapImage(const Napi::CallbackInfo &info)
{
    ...
    HGRABBER hGrabber = *info[0].As<Napi::External<HGRABBER>>().Data();
    int iTimeOutMillisek = info[1].As<Napi::Number>().int64_t();
    if (!info[1].isNumber())
    {
        Napi::TypeError::New(env, "Wrong type of argument 1").ThrowAsJavaScriptException();
        return env.Undefined();
...
Napi::Value f_IC_SaveImage(const Napi::CallbackInfo &info)
{
    ...
    HGRABBER hGrabber = *info[0].As<Napi::External<HGRABBER>>().Data();
    char *szFileName = info[1].As<Napi::String>().utf8Value().c_str();
    IMG_FILETYPE ft = (IMG_FILETYPE)info[2].As<Napi::Number>().int32_t();
    long quality = info[3].As<Napi::Number>().int64_t();
    if (!info[1].isString())
    {
        Napi::TypeError::New(env, "Wrong type of argument 1").ThrowAsJavaScriptException();
        return env.Undefined();
...
Napi::Value f_IC_GetSerialNumber(const Napi::CallbackInfo &info)
{
    ...
    HGRABBER hGrabber = *info[0].As<Napi::External<HGRABBER>>().Data();
    char *szSerial = info[1].As<Napi::String>().utf8Value().c_str();
    if (!info[1].isString())
    {
        Napi::TypeError::New(env, "Wrong type of argument 1").ThrowAsJavaScriptException();
        return env.Undefined();
...
Napi::Value f_IC_ListDevices(const Napi::CallbackInfo &info)
{
    ...
    char *szDeviceList = info[0].As<Napi::String>().utf8Value().c_str();
    int iSize = info[1].As<Napi::Number>().int64_t();
    if (!info[0].isString())
    {
        Napi::TypeError::New(env, "Wrong type of argument 0").ThrowAsJavaScriptException();
        return env.Undefined();
...
Napi::Value f_IC_ListDevicesbyIndex(const Napi::CallbackInfo &info)
{
    ...
    char *szDeviceName = info[0].As<Napi::String>().utf8Value().c_str();
    int iSize = info[1].As<Napi::Number>().int64_t();
    int DeviceIndex = info[2].As<Napi::Number>().int64_t();
    if (!info[0].isString())
    {
        Napi::TypeError::New(env, "Wrong type of argument 0").ThrowAsJavaScriptException();
        return env.Undefined();
...
Napi::Value f_IC_ListVideoFormats(const Napi::CallbackInfo &info)
{
    ...
    HGRABBER hGrabber = *info[0].As<Napi::External<HGRABBER>>().Data();
    char *szFormatList = info[1].As<Napi::String>().utf8Value().c_str();
    int iSize = info[2].As<Napi::Number>().int64_t();
    if (!info[1].isString())
    {
        Napi::TypeError::New(env, "Wrong type of argument 1").ThrowAsJavaScriptException();
        return env.Undefined();
...
Napi::Value f_IC_ListVideoFormatbyIndex(const Napi::CallbackInfo &info)
{
    ...
    HGRABBER hGrabber = *info[0].As<Napi::External<HGRABBER>>().Data();
    char *szFormatName = info[1].As<Napi::String>().utf8Value().c_str();
    int iSize = info[2].As<Napi::Number>().int64_t();
    int iIndex = info[3].As<Napi::Number>().int64_t();
    if (!info[1].isString())
    {
        Napi::TypeError::New(env, "Wrong type of argument 1").ThrowAsJavaScriptException();
        return env.Undefined();
...
Napi::Value f_IC_GetDevice(const Napi::CallbackInfo &info)
{
    ...
    int iIndex = info[0].As<Napi::Number>().int64_t();
    if (!info[0].isNumber())
    {
        Napi::TypeError::New(env, "Wrong type of argument 0").ThrowAsJavaScriptException();
        return env.Undefined();
...
Napi::Value f_IC_GetInputChannel(const Napi::CallbackInfo &info)
{
    ...
    HGRABBER hGrabber = *info[0].As<Napi::External<HGRABBER>>().Data();
    int iIndex = info[1].As<Napi::Number>().int64_t();
    if (!info[1].isNumber())
    {
        Napi::TypeError::New(env, "Wrong type of argument 1").ThrowAsJavaScriptException();
        return env.Undefined();
...
Napi::Value f_IC_LoadDeviceStateFromFileEx(const Napi::CallbackInfo &info)
{
    ...
    HGRABBER hGrabber = *info[0].As<Napi::External<HGRABBER>>().Data();
    char *szFileName = info[1].As<Napi::String>().utf8Value().c_str();
    int OpenDevice = info[2].As<Napi::Number>().int64_t();
    if (!info[1].isString())
    {
        Napi::TypeError::New(env, "Wrong type of argument 1").ThrowAsJavaScriptException();
        return env.Undefined();
...
Napi::Value f_IC_OpenDevByDisplayName(const Napi::CallbackInfo &info)
{
    ...
    HGRABBER hGrabber = *info[0].As<Napi::External<HGRABBER>>().Data();
    char *szDisplayname = info[1].As<Napi::String>().utf8Value().c_str();
    if (!info[1].isString())
    {
        Napi::TypeError::New(env, "Wrong type of argument 1").ThrowAsJavaScriptException();
        return env.Undefined();
...
Napi::Value f_IC_GetDisplayName(const Napi::CallbackInfo &info)
{
    ...
    HGRABBER hGrabber = *info[0].As<Napi::External<HGRABBER>>().Data();
    char *szDisplayname = info[1].As<Napi::String>().utf8Value().c_str();
    int iLen = info[2].As<Napi::Number>().int64_t();
    if (!info[1].isString())
    {
        Napi::TypeError::New(env, "Wrong type of argument 1").ThrowAsJavaScriptException();
        return env.Undefined();
...
Napi::Value f_IC_GetUniqueName(const Napi::CallbackInfo &info)
{
    ...
    HGRABBER hGrabber = *info[0].As<Napi::External<HGRABBER>>().Data();
    char *szUniquename = info[1].As<Napi::String>().utf8Value().c_str();
    int iLen = info[2].As<Napi::Number>().int64_t();
    if (!info[1].isString())
    {
        Napi::TypeError::New(env, "Wrong type of argument 1").ThrowAsJavaScriptException();
    ...
    IC_GetUniqueName f = *f_ptr;
    int ret = f(hGrabber, szUniquename, iLen);
    Napi::Object retObj = Napi::Object::New(env);
    retObj.Set("result", Napi::Number::New(env, ret));
    return retObj;
}
...
Napi::Value f_IC_EnableTrigger(const Napi::CallbackInfo &info)
{
    ...
    HGRABBER hGrabber = *info[0].As<Napi::External<HGRABBER>>().Data();
    int iEnable = info[1].As<Napi::Number>().int64_t();
    if (!info[1].isNumber())
    {
        Napi::TypeError::New(env, "Wrong type of argument 1").ThrowAsJavaScriptException();
        return env.Undefined();
...
Napi::Value f_IC_MsgBox(const Napi::CallbackInfo &info)
{
    ...
    char *szText = info[0].As<Napi::String>().utf8Value().c_str();
    char *szTitle = info[1].As<Napi::String>().utf8Value().c_str();
    if (!info[0].isString())
    {
        Napi::TypeError::New(env, "Wrong type of argument 0").ThrowAsJavaScriptException();
        return env.Undefined();
...
Napi::Value f_IC_SetFrameReadyCallbackEx(const Napi::CallbackInfo &info)
{
    ...
    IC_SetFrameReadyCallbackEx f = *f_ptr;
    int ret = f(hGrabber, cb, x1_argument_in_void_userdata);
    Napi::Object retObj = Napi::Object::New(env);
    retObj.Set("result", Napi::Number::New(env, ret));
    return retObj;
}
Napi::Value f_IC_SetFrameReadyCallback(const Napi::CallbackInfo &info)
{
    Napi::Env env = info.Env();
    if (info.Length() != 3)
    {
    ...
    IC_SetFrameReadyCallback *f_ptr = (IC_SetFrameReadyCallback *)GetProcAddress(tisgrabber, "IC_SetFrameReadyCallback");
    if (f_ptr == NULL)
    {
        FreeLibrary(tisgrabber);
        Napi::Error::New(env, "Cannot find function IC_SetFrameReadyCallback in tisgrabber_x64.dll").ThrowAsJavaScriptException();
        return env.Undefined();
    };
    IC_SetFrameReadyCallback f = *f_ptr;
    int ret = f(hGrabber, cb, x1_argument_in_void_userdata);
    Napi::Object retObj = Napi::Object::New(env);
    retObj.Set("result", Napi::Number::New(env, ret));
    return retObj;
}
Napi::Value f_IC_SetCallbacks(const Napi::CallbackInfo &info)
{
    Napi::Env env = info.Env();
    if (info.Length() != 5)
    {
    ...
    IC_SetCallbacks f = *f_ptr;
    int ret = f(hGrabber, cb, x1_argument_in_void_userdata, dlCB, x2_argument_in_void_userdata);
    Napi::Object retObj = Napi::Object::New(env);
    retObj.Set("result", Napi::Number::New(env, ret));
    return retObj;
}
Napi::Value f_IC_SetContinuousMode(const Napi::CallbackInfo &info)
{
    ...
    HGRABBER hGrabber = *info[0].As<Napi::External<HGRABBER>>().Data();
    int cont = info[1].As<Napi::Number>().int64_t();
    if (!info[1].isNumber())
    {
        Napi::TypeError::New(env, "Wrong type of argument 1").ThrowAsJavaScriptException();
        return env.Undefined();
...
Napi::Value f_IC_SetFrameRate(const Napi::CallbackInfo &info)
{
    ...
    HGRABBER hGrabber = *info[0].As<Napi::External<HGRABBER>>().Data();
    float FrameRate = info[1].As<Napi::Number>().int64_t();
    if (!info[1].isNumber())
    {
        Napi::TypeError::New(env, "Wrong type of argument 1").ThrowAsJavaScriptException();
        return env.Undefined();
...
Napi::Value f_IC_GetAvailableFrameRates(const Napi::CallbackInfo &info)
{
    ...
    HGRABBER hGrabber = *info[0].As<Napi::External<HGRABBER>>().Data();
    int Index = info[1].As<Napi::Number>().int64_t();
    float *fps;
    if (!info[1].isNumber())
    {
        Napi::TypeError::New(env, "Wrong type of argument 1").ThrowAsJavaScriptException();
...
Napi::Value f_IC_SetDefaultWindowPosition(const Napi::CallbackInfo &info)
{
    ...
    HGRABBER hGrabber = *info[0].As<Napi::External<HGRABBER>>().Data();
    int Default = info[1].As<Napi::Number>().int64_t();
    if (!info[1].isNumber())
    {
        Napi::TypeError::New(env, "Wrong type of argument 1").ThrowAsJavaScriptException();
        return env.Undefined();
...
Napi::Value f_IC_SetWindowPosition(const Napi::CallbackInfo &info)
{
    ...
    HGRABBER hGrabber = *info[0].As<Napi::External<HGRABBER>>().Data();
    int PosX = info[1].As<Napi::Number>().int64_t();
    int PosY = info[2].As<Napi::Number>().int64_t();
    int Width = info[3].As<Napi::Number>().int64_t();
    int Height = info[4].As<Napi::Number>().int64_t();
    if (!info[1].isNumber())
    {
        Napi::TypeError::New(env, "Wrong type of argument 1").ThrowAsJavaScriptException();
        return env.Undefined();
...
Napi::Value f_IC_SetWhiteBalanceAuto(const Napi::CallbackInfo &info)
{
    ...
    HGRABBER hGrabber = *info[0].As<Napi::External<HGRABBER>>().Data();
    int iOnOff = info[1].As<Napi::Number>().int64_t();
    if (!info[1].isNumber())
    {
        Napi::TypeError::New(env, "Wrong type of argument 1").ThrowAsJavaScriptException();
        return env.Undefined();
...
Napi::Value f_IC_GetTriggerModes(const Napi::CallbackInfo &info)
{
    ...
    HGRABBER hGrabber = *info[0].As<Napi::External<HGRABBER>>().Data();
    char *szModeList = info[1].As<Napi::String>().utf8Value().c_str();
    int iSize = info[2].As<Napi::Number>().int64_t();
    if (!info[1].isString())
    {
        Napi::TypeError::New(env, "Wrong type of argument 1").ThrowAsJavaScriptException();
...
Napi::Value f_IC_SetTriggerMode(const Napi::CallbackInfo &info)
{
    ...
    HGRABBER hGrabber = *info[0].As<Napi::External<HGRABBER>>().Data();
    char *szMode = info[1].As<Napi::String>().utf8Value().c_str();
    if (!info[1].isString())
    {
        Napi::TypeError::New(env, "Wrong type of argument 1").ThrowAsJavaScriptException();
        return env.Undefined();
...
Napi::Value f_IC_SetTriggerPolarity(const Napi::CallbackInfo &info)
{
    ...
    HGRABBER hGrabber = *info[0].As<Napi::External<HGRABBER>>().Data();
    int iPolarity = info[1].As<Napi::Number>().int64_t();
    if (!info[1].isNumber())
    {
        Napi::TypeError::New(env, "Wrong type of argument 1").ThrowAsJavaScriptException();
        return env.Undefined();
...
Napi::Value f_IC_SetExpRegVal(const Napi::CallbackInfo &info)
{
    ...
    HGRABBER hGrabber = *info[0].As<Napi::External<HGRABBER>>().Data();
    long lValue = info[1].As<Napi::Number>().int64_t();
    if (!info[1].isNumber())
    {
        Napi::TypeError::New(env, "Wrong type of argument 1").ThrowAsJavaScriptException();
        return env.Undefined();
...
Napi::Value f_IC_SetExpAbsVal(const Napi::CallbackInfo &info)
{
    ...
    HGRABBER hGrabber = *info[0].As<Napi::External<HGRABBER>>().Data();
    float fValue = info[1].As<Napi::Number>().int64_t();
    if (!info[1].isNumber())
    {
        Napi::TypeError::New(env, "Wrong type of argument 1").ThrowAsJavaScriptException();
        return env.Undefined();
...
Napi::Value f_IC_SetColorEnhancement(const Napi::CallbackInfo &info)
{
    ...
    HGRABBER hGrabber = *info[0].As<Napi::External<HGRABBER>>().Data();
    int OnOff = info[1].As<Napi::Number>().int64_t();
    if (!info[1].isNumber())
    {
        Napi::TypeError::New(env, "Wrong type of argument 1").ThrowAsJavaScriptException();
        return env.Undefined();
...
Napi::Value f_IC_SetWhiteBalanceRed(const Napi::CallbackInfo &info)
{
    ...
    HGRABBER hGrabber = *info[0].As<Napi::External<HGRABBER>>().Data();
    long Value = info[1].As<Napi::Number>().int64_t();
    if (!info[1].isNumber())
    {
        Napi::TypeError::New(env, "Wrong type of argument 1").ThrowAsJavaScriptException();
        return env.Undefined();
...
Napi::Value f_IC_enumProperties(const Napi::CallbackInfo &info)
{
    ...
    IC_enumProperties f = *f_ptr;
    int ret = f(hGrabber, cb, data);
    Napi::Object retObj = Napi::Object::New(env);
    retObj.Set("result", Napi::Number::New(env, ret));
    return retObj;
}
...
Napi::Value f_IC_enumPropertyElements(const Napi::CallbackInfo &info)
{
    ...
    IC_enumPropertyElements f = *f_ptr;
    int ret = f(hGrabber, Property, cb, data);
    Napi::Object retObj = Napi::Object::New(env);
    retObj.Set("result", Napi::Number::New(env, ret));
    return retObj;
}
Napi::Value f_IC_enumPropertyElementInterfaces(const Napi::CallbackInfo &info)
{
    ...
    IC_enumPropertyElementInterfaces f = *f_ptr;
    int ret = f(hGrabber, Property, Element, cb, data);
    Napi::Object retObj = Napi::Object::New(env);
    retObj.Set("result", Napi::Number::New(env, ret));
    return retObj;
}
...
Napi::Value f_IC_SetPropertyValue(const Napi::CallbackInfo &info)
{
    ...
    char *Property = info[1].As<Napi::String>().utf8Value().c_str();
    char *Element = info[2].As<Napi::String>().utf8Value().c_str();
    int Value = info[3].As<Napi::Number>().int64_t();
    if (!info[1].isString())
    {
        Napi::TypeError::New(env, "Wrong type of argument 1").ThrowAsJavaScriptException();
        return env.Undefined();
...
Napi::Value f_IC_SetPropertyAbsoluteValue(const Napi::CallbackInfo &info)
{
    ...
    char *Property = info[1].As<Napi::String>().utf8Value().c_str();
    char *Element = info[2].As<Napi::String>().utf8Value().c_str();
    float Value = info[3].As<Napi::Number>().int64_t();
    if (!info[1].isString())
    {
        Napi::TypeError::New(env, "Wrong type of argument 1").ThrowAsJavaScriptException();
        return env.Undefined();
...
Napi::Value f_IC_SetPropertySwitch(const Napi::CallbackInfo &info)
{
    ...
    char *Property = info[1].As<Napi::String>().utf8Value().c_str();
    char *Element = info[2].As<Napi::String>().utf8Value().c_str();
    int On = info[3].As<Napi::Number>().int64_t();
    if (!info[1].isString())
    {
        Napi::TypeError::New(env, "Wrong type of argument 1").ThrowAsJavaScriptException();
        return env.Undefined();
...
Napi::Value f_IC_GetPropertyMapString(const Napi::CallbackInfo &info)
{
    ...
    char *Element = info[2].As<Napi::String>().utf8Value().c_str();
    int *StringLength;
    char *String = info[4].As<Napi::String>().utf8Value().c_str();
    if (!info[1].isString())
    {
        Napi::TypeError::New(env, "Wrong type of argument 1").ThrowAsJavaScriptException();
        return env.Undefined();
...
Napi::Value f_IC_SetPropertyMapString(const Napi::CallbackInfo &info)
{
    ...
    char *Property = info[1].As<Napi::String>().utf8Value().c_str();
    char *Element = info[2].As<Napi::String>().utf8Value().c_str();
    char *String = info[3].As<Napi::String>().utf8Value().c_str();
    if (!info[1].isString())
    {
        Napi::TypeError::New(env, "Wrong type of argument 1").ThrowAsJavaScriptException();
        return env.Undefined();
...
Napi::Value f_IC_CreateFrameFilter(const Napi::CallbackInfo &info)
{
    ...
    char *szFilterName = info[0].As<Napi::String>().utf8Value().c_str();
    if (!info[0].isString())
    {
        Napi::TypeError::New(env, "Wrong type of argument 0").ThrowAsJavaScriptException();
        return env.Undefined();
...
Napi::Value f_IC_FrameFilterGetParameter(const Napi::CallbackInfo &info)
{
    ...
    HFRAMEFILTER FilterHandle = *info[0].As<Napi::External<HFRAMEFILTER>>().Data();
    char *ParameterName = info[1].As<Napi::String>().utf8Value().c_str();
    if (!info[1].isString())
    {
        Napi::TypeError::New(env, "Wrong type of argument 1").ThrowAsJavaScriptException();
        return env.Undefined();
...
Napi::Value f_IC_FrameFilterSetParameterInt(const Napi::CallbackInfo &info)
{
    ...
    HFRAMEFILTER FilterHandle = *info[0].As<Napi::External<HFRAMEFILTER>>().Data();
    char *ParameterName = info[1].As<Napi::String>().utf8Value().c_str();
    int Data = info[2].As<Napi::Number>().int64_t();
    if (!info[1].isString())
    {
        Napi::TypeError::New(env, "Wrong type of argument 1").ThrowAsJavaScriptException();
        return env.Undefined();
...
Napi::Value f_IC_FrameFilterSetParameterFloat(const Napi::CallbackInfo &info)
{
    ...
    HFRAMEFILTER FilterHandle = *info[0].As<Napi::External<HFRAMEFILTER>>().Data();
    char *ParameterName = info[1].As<Napi::String>().utf8Value().c_str();
    float Data = info[2].As<Napi::Number>().int64_t();
    if (!info[1].isString())
    {
        Napi::TypeError::New(env, "Wrong type of argument 1").ThrowAsJavaScriptException();
        return env.Undefined();
...
Napi::Value f_IC_FrameFilterSetParameterString(const Napi::CallbackInfo &info)
{
    ...
    HFRAMEFILTER FilterHandle = *info[0].As<Napi::External<HFRAMEFILTER>>().Data();
    char *ParameterName = info[1].As<Napi::String>().utf8Value().c_str();
    char *Data = info[2].As<Napi::String>().utf8Value().c_str();
    if (!info[1].isString())
    {
        Napi::TypeError::New(env, "Wrong type of argument 1").ThrowAsJavaScriptException();
        return env.Undefined();
...
Napi::Value f_IC_enumCodecs(const Napi::CallbackInfo &info)
{
    Napi::Env env = info.Env();
    if (info.Length() != 2)
    {
    ...
    IC_enumCodecs *f_ptr = (IC_enumCodecs *)GetProcAddress(tisgrabber, "IC_enumCodecs");
    if (f_ptr == NULL)
    {
        FreeLibrary(tisgrabber);
        Napi::Error::New(env, "Cannot find function IC_enumCodecs in tisgrabber_x64.dll").ThrowAsJavaScriptException();
        return env.Undefined();
    };
    IC_enumCodecs f = *f_ptr;
    f(cb, data);
    Napi::Object retObj = Napi::Object::New(env);
    retObj.Set("result", env.Undefined());
    return retObj;
...
Napi::Value f_IC_Codec_Create(const Napi::CallbackInfo &info)
{
    ...
    char *Name = info[0].As<Napi::String>().utf8Value().c_str();
    if (!info[0].isString())
    {
        Napi::TypeError::New(env, "Wrong type of argument 0").ThrowAsJavaScriptException();
        return env.Undefined();
...
Napi::Value f_IC_Codec_getName(const Napi::CallbackInfo &info)
{
    ...
    HCODEC Codec = *info[0].As<Napi::External<HCODEC>>().Data();
    int l = info[1].As<Napi::Number>().int64_t();
    char *Name = info[2].As<Napi::String>().utf8Value().c_str();
    if (!info[1].isNumber())
    {
        Napi::TypeError::New(env, "Wrong type of argument 1").ThrowAsJavaScriptException();
        return env.Undefined();
...
Napi::Value f_IC_SetAVIFileName(const Napi::CallbackInfo &info)
{
    ...
    HGRABBER hlGrabber = *info[0].As<Napi::External<HGRABBER>>().Data();
    char *FileName = info[1].As<Napi::String>().utf8Value().c_str();
    if (!info[1].isString())
    {
        Napi::TypeError::New(env, "Wrong type of argument 1").ThrowAsJavaScriptException();
        return env.Undefined();
...
Napi::Value f_IC_enableAVICapturePause(const Napi::CallbackInfo &info)
{
    ...
    HGRABBER hlGrabber = *info[0].As<Napi::External<HGRABBER>>().Data();
    int Pause = info[1].As<Napi::Number>().int64_t();
    if (!info[1].isNumber())
    {
        Napi::TypeError::New(env, "Wrong type of argument 1").ThrowAsJavaScriptException();
        return env.Undefined();
...
Napi::Value f_IC_SetRingBufferSize(const Napi::CallbackInfo &info)
{
    ...
    HGRABBER hGrabber = *info[0].As<Napi::External<HGRABBER>>().Data();
    int Count = info[1].As<Napi::Number>().int64_t();
    if (!info[1].isNumber())
    {
        Napi::TypeError::New(env, "Wrong type of argument 1").ThrowAsJavaScriptException();
        return env.Undefined();
...
Napi::Value f_IC_MemBufferLock(const Napi::CallbackInfo &info)
{
    ...
    HMEMBUFFER hBuffer = *info[0].As<Napi::External<HMEMBUFFER>>().Data();
    int lock = info[1].As<Napi::Number>().int64_t();
    if (!info[1].isNumber())
    {
        Napi::TypeError::New(env, "Wrong type of argument 1").ThrowAsJavaScriptException();
        return env.Undefined();
